...
class wpgrade_social_links_widget extends WP_Widget {
	...
	{
		parent::__construct( 'wpgrade_social_links', wpgrade::themename().' '.__('Social Links', 'border_txtd' ), array('description' => __( "Display the social links defined in the theme's options", 'border_txtd' )) );
	}
	...
	function form($instance) {
		!empty($instance['title'])  ? $title = esc_attr($instance['title']) : $title = __('We Are Social','border_txtd'); ?>

		<p>
			<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title', 'border_txtd'); ?>:</label>
