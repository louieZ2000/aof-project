<?php
/*
 * Gallery Cover Style 1
 */
?><div class="gallery-item cover--style1" itemscope itemtype="http://schema.org/ImageObject" data-caption="<?php echo htmlspecialchars( $attachment->post_excerpt ) ?>" data-description="<?php echo htmlspecialchars( $attachment->post_content ) ?>">
                ...
                <div class="cover__content">
                    <style>
                        html .cover__sub-title {
							<?php wpgrade::display_font_params(wpgrade::option('gallery_cover_subtitle_font_style1')); ?>
                        }

                        html .cover__title {
                            <?php wpgrade::display_font_params(wpgrade::option('gallery_cover_title_font_style1')); ?>
                        }
