...
?>
<div class="mosaic-wrapper" data-itemstype="gallery" data-itemslayout="masonry">

<?php wpgrade_display_mosaic(wpgrade::shortname().'_gallery',$galleries_per_page,true,$taxonomy,$show_filtering,'small-size',$classes); ?>
