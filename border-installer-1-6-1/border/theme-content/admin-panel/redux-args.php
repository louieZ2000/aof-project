...
//		'last_tab' => '0', # default: '0'
		...
		'intro_text' => __('<h4>Theme Options</h4><p>These allow you to adjust the overall settings for your website.</p>', 'border_txtd'),

		// add content after the form
//		'footer_text' => __('<p>This text is displayed below the options panel. It isn\'t required, but more info is always better! The footer_text field accepts all HTML.</p>', 'border_txtd'),

		// set footer/credit line
//		'footer_credit' => __('<p>This text is displayed in the options panel footer across from the WordPress version (where it normally says \'Thank you for creating with WordPress\'). This field accepts all HTML.</p>', 'border_txtd'),
			...
			(
				'twitter' => array
					(
						...
						'title' => __('Follow us on Twitter', 'border_txtd'),
				...
				'linked_in' => array
					(
						...
						'title' => __('Find us on LinkedIn', 'border_txtd'),
				...
				'facebook' => array
					(
						...
						'title' => __('Find us on Facebook', 'border_txtd'),
...
//		'import_icon' => 'refresh', # default: refresh
		...
		'menu_title' => __('Theme Options', 'border_txtd'), # default: Options

		// Set a custom page title for the options page.
		'page_title' => __('Options', 'border_txtd'), # default: Options
...
//				(
//					'id' => 'redux-opts-1',
//					'title' => __('Theme Information 1', 'border_txtd'),
//					'content' => __('<p>This is the tab content, HTML is allowed.</p>', 'border_txtd')
//				),
//				array
//				(
//					'id' => 'redux-opts-2',
//					'title' => __('Theme Information 2', 'border_txtd'),
//					'content' => __('<p>This is the tab content, HTML is allowed.</p>', 'border_txtd')
//				)
//			),

		// Set the help sidebar for the options page.
		// 'help_sidebar' => __('<p>This is the sidebar content, HTML is allowed.</p>', 'border_txtd'),
