...
mlPushMenu.prototype = {
    ...
    _openMenu : function( subLevel ) {
     ...
     //    }
        ...
        // TweenMax.to(subLevel || this.levels[0], 0.5, {x: ""+translateVal+"", ease:Expo.easeInOut,  width: ""+menuWidth+"" });
 TweenMax.to(subLevel || this.levels[0], 0.5, {x: ""+translateVal+"", ease:Expo.easeInOut});
    ...
    _closeAllLevels : function(el) {
        ...
        // TweenMax.to($('.sub-menu'), 0.5, {x: 0, ease:Expo.easeInOut, width: "10" , onComplete: function(){
...
/*===================== START RESPONSED.JS ==================*/
/* Docs found http://responsejs.com/  */
...
(function ($, R) {
    ...
    Response.ready(function () {
        if (R.viewportW() <= mobileBreakpoint) {
            ...
            $(window).scroll(function() {    
                ...
                var scrollnav = $(".site-header");
                if (scroll >= 50) {
                    $(scrollnav).addClass("fixedImportant fadeInDown");
                    
                    $(scrollnav).css("top", 0);

                } else {
                    $(scrollnav).removeClass("fixedImportant fadeInDown");
                    $(scrollnav).css("top", 'inhert');
                }
        ...
        } else if (R.viewportW() >= mobileBreakpoint && R.viewportW() <= tabletPortraitBreakpoint) {
...
$('.squared-grid .grid__item').height($('.squared-grid .grid__item').width());
