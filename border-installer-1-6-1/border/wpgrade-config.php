...
//		'xml-file' => 'border.xml',
	...
	'shortcodes' => array
	(
		'Columns', 'Button', 'Icon', 'Tabs', 'Quote', 'Separator', 'Slider', 'ProgressBar', 'TeamMember'
	),
	...
	(
		...
		(
			...
			(
				...
				(
					'path' => get_template_directory_uri().'/theme-content/css/new_style.css',
					'cache_bust' => wpgrade::cachebust_string(wpgrade::themefilepath('theme-content/css/new_style.css')),
				)
			)
		...
		(
			'wpgrade-main-scripts' =>
				...
				(
					...
					'objectl10n' => array
					(
						'tPrev' => __('Previous (Left arrow key)', 'border_txtd'),
						'tNext' => __('Next (Right arrow key)', 'border_txtd'),
						'tCounter' => __('of', 'border_txtd'),
						'infscrLoadingText' => __("<em>Loading more...</em>", 'border_txtd'),
						'infscrReachedEnd' => __("<em>Nothing left to load.</em>", 'border_txtd'),
					),
				),
		),
		...
		(
			'dynamic-css' => array
			(
				'handler' => 'wpgrade_callback_enqueue_dynamic_css_border',
				'priority' => 9999,
			),
	...
	(
		...
		// pagination text
		'prev_text' => __('Prev', 'border_txtd'),
		'next_text' => __('Next', 'border_txtd'),
...
//					(
//						'formatter' => null,
//						'prev_text' => __('Prev Images', 'border_txtd'),
//						'next_text' => __('Next Images', 'border_txtd'),
//					)
	),
