...
class WPGradePaginationFormatter {
	...
	protected function setup() {
		...
		if ( empty( $conf['prev_text'] ) ) {
			$conf['prev_text'] = __( '&laquo; Previous', 'border_txtd' );
		} else { // exists; translate
			$conf['prev_text'] = __( $conf['prev_text'], 'border_txtd' );
		}

		if ( empty( $conf['next_text'] ) ) {
			$conf['next_text'] = __( 'Next &raquo;', 'border_txtd' );
		} else { // exists; translate
			$conf['next_text'] = __( $conf['next_text'], 'border_txtd' );
		}
